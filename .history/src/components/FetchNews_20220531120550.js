...
export default function FetchNews() {
  ...
  return (
    <>
      <main style={{ display: "flex", background: "#111827" }}>
        {isLoading ? (
          ...
          <div>
            ...
            <article className="my-10 flex flex-col items-center justify-center container lg:max-w-4xl mx-auto px-5">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="border-b border-gray-700 text-white text-lg hover:text-gray-400 hover:border-gray-400"
              >
                Read Full Story
              </a>
            </article>
            ...
            <section className="grid grid-cols-1 gap-5 p-5 md:grid-cols-2 container mx-auto lg:max-w-xl text-white">
              {items.map((item) => {
                ...
                return (
                  ...
                  >
                    <h3 className="text-gray-400 mt-10">{title}</h3>
