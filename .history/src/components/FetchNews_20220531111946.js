            ...
            <section className="grid grid-cols-1 gap-5 p-5 md:grid-cols-2 container mx-auto lg:max-w-xl">
              {items.map((item) => {
                ...
                return (
                  <article
                    key={objectID}
                    className="bg-gray-400 rounded p-3 transition-all duration-150"
                  >
                    ...
                    <article className="flex items-center justify-between">
                      ...
                      <a
                        ...
                        className="border-b border-gray-700 text-gray-600 text-lg hover:text-gray-800 hover:border-gray-400"
                      >
                        Read More
                      </a>
                    </article>
