...
function MTStudet() {
  ...
  const columns = [
    {
      title: "Full_names", field: "Full_names", validate: (rowData) => 
      rowData.Full_names === undefined || rowData.Full_names === "" ? "Required" : true,
    },
    
    {
      title: "admision_number", field: "admision_number", validate: (rowData) =>
